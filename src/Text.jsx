        ...
        <div className="w-screen h-screen bg-[#E0D0C2] flex justify-center items-center">
            ...
            <Link to="./confirm" target="_self">
                ...
                <div className="h-[60px] relative flex top-7 left-7 justify-between">
                    <div className='flex'>
                        <Link to="./add" target="_self">
                            <div className='w-[60px] h-[60px] bg-[rgb(224,209,194)]  rounded-full flex items-center justify-center mr-5'>
                                <p className='text-black font-bold  text-2xl'>1</p>
                            </div>
                        </Link>
                        <div className='w-[60px] h-[60px] bg-[#84A29F] rounded-full flex items-center justify-center'>
                ...
                <div className="h-[60px] relative top-14 left-8 flex justify-between">
                    <p className='text-black font-bold text-5xl'>Write something...</p>
              </div>
              <div className='bg-[#D2E0EE] h-[450px] w-[1000px] mx-auto mt-[100px] flex flex-col justify-center items-center font-bold'>
                <h1 className='text-4xl text-gray-400'>What's on your mind?</h1>
            </div>
            </div>
         </div>
      )
